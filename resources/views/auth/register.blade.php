                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="d-flex ms-3 gap-3">
                            <a href="{{ route('login') }}"
                               class="btn btn-white btn-sm px-4 radius-30">Login</a>
                            <a href="{{ route('register') }}"
                               class="btn btn-primary btn-sm px-4 radius-30">Register</a>
                        </div>
                    </div>
                </div>
            </nav>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12 ">
                                                ...
                                                <div class="ms-auto position-relative">
                                                    ...
                                                    <input type="name" name="name" class="form-control radius-30 ps-5"
                                            ...
                                            <div class="col-12 text-center">
                                                <p class="mb-0">Already have an account? <a
                                                       href="authentication-signin-with-header-footer.html">Sign in here</a></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
